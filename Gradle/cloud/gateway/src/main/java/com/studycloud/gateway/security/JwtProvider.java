...
public class JwtProvider {
  ...
  */
  ...
  UserInfo getUserInfo(String accessToken) {
    ...
    return UserInfo.builder().id(userId).authorities(authorities).build();
  }
